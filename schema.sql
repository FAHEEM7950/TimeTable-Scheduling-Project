...
-- 8. Timetable Table
-- Each row holds a specific day's schedule for a branch, year, semester, and college.
-- The periods store strings in the format: "SubjectName (FacultyName)" or "FREE"
